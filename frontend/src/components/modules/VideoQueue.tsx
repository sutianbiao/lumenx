...
function TaskCard({ task, onRemix }: { task: VideoTask; onRemix: (t: VideoTask) => void }) {
    ...
    const API_URL = "http://localhost:17177"; // Should import from config/env but hardcoding for quick fix in this component context or better pass as prop
                ...
                <div>
                    ...
                    <div className="flex h-32 relative group">
                        ...
                        <div className="w-1/2 relative bg-black">
                            {task.video_url ? (
                                <video
                                    src={`http://localhost:17177/files/${task.video_url}`}
                                    controls
